      ...
      <div className="flex flex-col gap-6">
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4 text-center">
          ...
          <div className="flex justify-around gap-4">
            <div>
              <div className="text-lg font-bold text-yellow-500">🪙 Moedas</div>
              <div className="text-xl font-bold">{profile ? profile.coins : "…"}</div>
            </div>
            <div>
              <div className="text-lg font-bold text-pink-500">💎 Gemas</div>
              <div className="text-xl font-bold">{profile ? profile.gems : "…"}</div>
            </div>
          </div>
        </div>
